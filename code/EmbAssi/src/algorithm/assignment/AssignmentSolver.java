...
public abstract class AssignmentSolver {
	...
	public static class KuhnMunkres extends AssignmentSolver {
		@Override
		public int[] solve(double[][] costs) {
			if (costs.length == 0) return new int[0];
	...
	public static class KuhnMunkresWong extends AssignmentSolver {
		@Override
		public int[] solve(double[][] costs) {
			if (costs.length == 0) return new int[0];
			KuhnMunkresWongAlgorithm km = new KuhnMunkresWongAlgorithm();
			return km.run(costs);
		}
	}
