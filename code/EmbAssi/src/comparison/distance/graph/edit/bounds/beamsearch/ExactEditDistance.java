 ...
 *
 */
public class ExactEditDistance<V,E> {
	private GraphEditCosts<V,E> graphEditCosts;
	private int s;
	
	public ExactEditDistance(GraphEditCosts<V,E> graphEditCosts, int s)
	{
	 ...
	 *
	 */
	public double getEditDistance(LGraph<V,E> g1, LGraph<V,E> g2, double bound) {
		if (bound <= 0.){
			return 0;
		}
		...
		TreeNode<V,E> start = new TreeNode<V,E>(g1, g2, this.graphEditCosts);
		open.add(start);
	 ...
	 */
	public double getEditDistance(LGraph<V,E> g1, LGraph<V,E> g2, TreeNode<V,E> start) {
