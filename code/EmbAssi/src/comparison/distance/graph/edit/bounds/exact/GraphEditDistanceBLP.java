...
//	SolverFactory factory = new SolverFactoryCPLEX();
	SolverFactory factory = new SolverFactoryGurobi();
	{
		...
		if(this.timeout>0)
		{
			factory.setParameter(Solver.TIMEOUT, this.timeout); // set timeout (result might not be exact)
		}
		//factory.setParameter(Solver.TIMEOUT, 120);
		
	}
	
	protected int timeout;
	protected GraphEditCosts<V,E> gec;
	...
	public GraphEditDistanceBLP(GraphEditCosts<V,E> gec, int timeout) {
		this.gec = gec;
