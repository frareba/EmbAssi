...
import comparison.distance.graph.edit.bounds.exact.GraphEditDistanceBLP;
...
/**
 * Implements a lower bound based on the BLP-based GED computation according to F2 of 
 * 
 ...
 *
 */
public class GraphEditDistanceBLPF2lb<V,E> extends GraphEditDistanceBLP<V, E> {
	
	public GraphEditDistanceBLPF2lb() {
		super();
	}
	
	public GraphEditDistanceBLPF2lb(GraphEditCosts<V,E> gec) {
		this.gec = gec;
	}
	public GraphEditDistanceBLPF2lb(GraphEditCosts<V,E> gec, int timeout) {
		this.gec = gec;
