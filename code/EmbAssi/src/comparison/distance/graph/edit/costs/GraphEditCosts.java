package comparison.distance.graph.edit.costs;
...
public class GraphEditCosts<V,E> {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof GraphEditCosts)) return false;
		GraphEditCosts<?, ?> other = (GraphEditCosts<?, ?>)obj;
		return (other.vertexDeletionCost == this.vertexDeletionCost &&
				other.vertexInsertionCost == this.vertexInsertionCost &&
				other.edgeDeletionCost == this.edgeDeletionCost &&
				other.edgeInsertionCost == this.edgeInsertionCost &&
				other.edgeLabelDistance.equals(this.edgeLabelDistance) &&
				other.vertexLabelDistance.equals(this.vertexLabelDistance));
	}
